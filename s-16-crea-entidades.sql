...
-- TABLE: CREDENCIAL 
--
Prompt CREANDO TABLA CREDENCIAL
...
--
Prompt CREANDO TABLA CONTENIDO_MULTIMEDIA
...
--
Prompt CREANDO TABLA EMPLEADO_BIOMETRICOS
...
-- TABLE: ADMINISTRADOR 
--
Prompt CREANDO TABLA ADMINISTRADOR
...
-- TABLE: INSTRUCTOR 
--
Prompt CREANDO TABLA INSTRUCTOR
...
--
Prompt CREANDO TABLA INSTRUCTOR_URL
...
--dando privilegios a admin_m1 para referenciar administradores y gimnasios
connect sys/system2 as sysdba;
grant references on admin_m2.ADMINISTRADOR to admin_m1;
grant references on admin_m2.GIMNASIO to admin_m1;

connect admin_m1/admin;
-- 
-- TABLE: SALA 
--
Prompt CREANDO TABLA SALA
CREATE TABLE SALA(
    ...
    REFERENCES admin_m2.GIMNASIO(GIMNASIO_ID),
    CONSTRAINT SALA_RESPONSABLE_ID_FK FOREIGN KEY (RESPONSABLE_ID)
    REFERENCES admin_m2.ADMINISTRADOR(EMPLEADO_ID)
) TABLESPACE SALA_TS;
...
-- TABLE: DISCIPLINA 
--
Prompt CREANDO TABLA DISCIPLINA
...
--
Prompt CREANDO TABLA SALA_DISCIPLINA
...
--dando privilegios a admin_m1 para referenciar instructores
connect sys/system2 as sysdba;
grant references on admin_m2.INSTRUCTOR to admin_m1;

connect admin_m1/admin;
-- 
-- TABLE: SESION 
--
Prompt CREANDO TABLA SESION
CREATE TABLE SESION(
    ...
    REFERENCES admin_m2.INSTRUCTOR(EMPLEADO_ID),
...
--
Prompt CREANDO TABLA STATUS_DISPOSITIVO
...
--
Prompt CREANDO TABLA TIPO_DISPOSITIVO
...
-- TABLE: DISPOSITIVO 
--
Prompt CREANDO TABLA DISPOSITIVO
...
--
Prompt CREANDO TABLA DISPOSITIVOS_SESION
...
--
Prompt CREANDO TABLA HIST_STATUS_DISP
CREATE TABLE HIST_STATUS_DISP(
    ...
    USING INDEX(
      CREATE UNIQUE INDEX HIST_STATUS_DISP_PK ON HIST_STATUS_DISP(HIST_STATUS_DISP_ID)
      TABLESPACE INDICES_SC_TS
    ), 
...
CREATE INDEX SENSOR_CLIENTE_ID_FK_IX ON SENSOR(CLIENTE_ID) TABLESPACE indices_sc_ts;

-- 
-- INDEX: CREDENCIAL - CLIENTE_ID_FK
--

CREATE UNIQUE INDEX CREDENCIAL_CREDENCIAL_ID_FK_UK ON CREDENCIAL(CLIENTE_ID) TABLESPACE indices_sc_ts;

-- 
-- INDEX: MEDIDAS - CLIENTE_ID_FK
--

CREATE INDEX MEDIDAS_CLIENTE_ID_FK_IX ON MEDIDAS(CLIENTE_ID) TABLESPACE indices_sc_ts;

-- 
-- INDEX: SALA - RESPONSABLE_ID_FK
--

CREATE UNIQUE INDEX SALA_RESPONSABLE_ID_FK_UK ON SALA(RESPONSABLE_ID) TABLESPACE indices_sc_ts;

-- 
-- INDEX: BITACORA_CALORIAS - CLIENTE_ID_FK
--

CREATE INDEX BITACORA_CALORIAS_CLIENTE_ID_FK_IX ON BITACORA_CALORIAS(CLIENTE_ID) TABLESPACE indices_sc_ts;

-- 
-- INDEX: HIST_STATUS_DISP - DISPOSITIVO_ID_FK
--

CREATE INDEX HIST_STATUS_DISP_DISPOSITIVO_ID_FK_FK_IX ON HIST_STATUS_DISP(DISPOSITIVO_ID) TABLESPACE indices_sc_ts;

-- 
-- INDEX: EMPLEADO_BIOMETRICOS - EMPLEADO_ID_FK
--
connect admin_m2/admin;
CREATE INDEX EMPLEADO_BIOMETRICOS_EMPLEADO_ID_FK_IX ON EMPLEADO_BIOMETRICOS(EMPLEADO_ID) TABLESPACE indices_g_ts;


--
-- CONSTRAINT: GIMNASIO - ADMINISTRADOR_ID_FK
--
ALTER TABLE GIMNASIO ADD CONSTRAINT GIMNASIO_GERENTE_ID_FK FOREIGN KEY (GERENTE_ID)
